...
public interface ChatRoomRepository extends JpaRepository<ChatRoom, Long> {
    ...
    Page<ChatRoom> findDistinctByCategorys_CategoryOrTopicAContainingIgnoreCaseOrTopicBContainingIgnoreCaseOrderByCreatedAt(String category1 ,String category2, String category3,Pageable pageable);
